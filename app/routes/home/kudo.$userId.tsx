...
import { Kudo, Modal, SelectBox, UserCircle } from '~/components'
import { colorMap, createKudo, emojiMap, getUser, getUserById, requireUserId } from '~/utils'
...
export default function KudoModal() {
    ...
    //  handle changes to modal styles
    ...
    //  handle options selection for formating the kudos
