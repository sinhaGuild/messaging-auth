...
import {validateEmail, validateName, validatePassword, getUser, login, register} from '~/utils'
...
//  Action arrow function for validation of the form and login and register the user.
  ...
  return (
    <Layout>
      <div className="h-full justify-center items-center flex flex-col gap-y-4">
        ...
        <h2 className="text-5xl font-extrabold text-yellow-300">Welcome to WahWahee!</h2>
